...
class AboutClassMethods < Neo::Koan
  ...
  # Why would you do this? The method is already specific to this class.
  # When you create an instance of Dog, that object inherits all the methods
  # inside that class. On what occasions would you need to specify even further?
  # ------------------------------------------------------------------
  ...
  # Again, why do you need to make reference to the class with a method
  # already inside the relevant class?
  # ------------------------------------------------------------------
  ...
  # The second you'd use in instances where you were using a "constructor"
  # piece of code to create multiple sub-classes based on a dataset?
  # ------------------------------------------------------------------
